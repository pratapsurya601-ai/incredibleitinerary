...
export default function PinterestSaveButton({
  ...
  return (
    <a
      ...
      className={`inline-flex items-center gap-1.5 bg-[#E60023] hover:bg-[#ad081b] text-white text-[0.65rem] font-semibold px-2.5 py-1.5 rounded-full shadow-md transition-all duration-200 ${className}`}
    >
      {/* Pinterest P logo */}
