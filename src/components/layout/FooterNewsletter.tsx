        ...
        {status === "success" ? (
          ...
          <form onSubmit={handleSubmit} className="flex gap-2 w-full sm:w-auto sm:max-w-sm">
            <input
              ...
              required
              className="flex-1 bg-white/8 border border-white/15 rounded-lg px-3 py-2.5 text-sm text-white placeholder:text-white/30 focus:outline-none focus:border-gold/50 transition"
            />
            <button
              type="submit"
