      ...
      {[
        {
          ...
          href: `mailto:?subject=Bratislava 3-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Bratislava in 3 Days — Old Town, UFO Bridge and Devin Castle&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
