...
function ShareBar() {
  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      ...
      {[
        { label: "Email", color: "bg-ink text-white", href: `mailto:?subject=Alleppey 3-Day Itinerary&body=Check this out: ${pageUrl}` },
        { label: "Twitter", color: "bg-[#1a6fb5] text-white", href: `https://x.com/intent/tweet?text=Alleppey in 3 Days guide&url=${pageUrl}` },
      ].map((s) => (
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 p-4 bg-rose-50 border border-rose-200 rounded-xl mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-rose-700 font-light">Stay: 1N houseboat + 2N Marari homestay {"·"} {"₹"}3,000{"–"}{"₹"}6,000/night</p>
                  </div>
                </div>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-ink">
                    ...
                    <th className="p-3.5 text-xs font-medium text-teal-300 text-center">{"\uD83D\uDEF3\uFE0F"} Luxury</th>
                  </tr>
                </thead>
