      ...
      {[
        {
          ...
          href: `mailto:?subject=Hiroshima 2-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Hiroshima in 2 Days — Peace Memorial, Miyajima &amp; the Floating Torii&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
