      ...
      {[
        {
          ...
          href: `mailto:?subject=Istanbul 5-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Istanbul in 5 Days — Hagia Sophia, Bosphorus and the Grand Bazaar&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
