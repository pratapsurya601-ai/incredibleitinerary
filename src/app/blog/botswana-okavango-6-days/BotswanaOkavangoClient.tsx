      ...
      {[
        {
          ...
          href: `mailto:?subject=Botswana Okavango 6-Day Guide&body=Check this out: ${typeof window !== "undefined" ? window.location.href : ""}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1DA1F2] text-white",
          href: `https://x.com/intent/tweet?text=Botswana Okavango Delta in 6 Days — mokoro canoes, elephants and Africa&apos;s wildest wilderness&url=${typeof window !== "undefined" ? window.location.href : ""}`,
        },
      ].map((s) => (
        <a
          key={s.label}
