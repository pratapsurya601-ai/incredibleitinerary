      ...
      {[
        {
          ...
          href: `mailto:?subject=Kenya Safari 7-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Kenya Safari in 7 Days — Masai Mara, Amboseli and the Great Migration&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
