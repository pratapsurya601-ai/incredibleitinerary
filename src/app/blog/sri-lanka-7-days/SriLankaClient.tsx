      ...
      {[
        {
          ...
          href: `mailto:?subject=Sri Lanka 7-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Sri Lanka in 7 Days — Sigiriya, tea train and Galle Fort&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
