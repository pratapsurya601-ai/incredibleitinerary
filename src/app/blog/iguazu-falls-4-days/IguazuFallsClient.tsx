      ...
      {[
        {
          ...
          href: `mailto:?subject=Iguazu Falls 4-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Iguazu Falls in 4 Days — both sides, Devil%27s Throat and the Triple Frontier&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
