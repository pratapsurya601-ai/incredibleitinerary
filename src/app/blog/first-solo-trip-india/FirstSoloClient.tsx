      ...
      {[
        {
          ...
          href: `mailto:?subject=First Solo Trip India Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=First Solo Trip in India guide&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
