      ...
      {[
        {
          ...
          href: `mailto:?subject=Hampi 3-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Hampi in 3 Days — ruins, sunrises and the stone chariot&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
      ...
      <main id="main-content" className="bg-cream min-h-screen">
        ...
        <div className="max-w-[860px] mx-auto px-6 md:px-8 pt-10 pb-20">
          ...
          <div className="max-w-[860px] mx-auto px-6 md:px-8 mb-12">
            <h2 className="font-serif text-xl font-light text-ink mb-4">Plan your Hampi trip</h2>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {[
                { href: "/blog/best-time-to-visit-hampi", label: "Best time to visit", icon: "🗓️" },
                { href: "/blog/hampi-trip-cost-couple", label: "Trip cost breakdown", icon: "💰" },
                { href: "/blog/how-to-reach-hampi", label: "How to get there", icon: "✈️" },
                { href: "/blog/hampi-travel-tips", label: "Travel tips", icon: "📋" },
              ].map((item) => (
