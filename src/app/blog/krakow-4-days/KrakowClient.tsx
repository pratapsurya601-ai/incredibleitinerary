      ...
      {[
        {
          ...
          href: `mailto:?subject=Kraków 4-Day Guide&body=Check this out: ${typeof window !== "undefined" ? window.location.href : ""}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1DA1F2] text-white",
          href: `https://x.com/intent/tweet?text=Kraków in 4 Days — Auschwitz, Wieliczka Salt Mine &amp; the medieval Old Town&url=${typeof window !== "undefined" ? window.location.href : ""}`,
        },
      ].map((s) => (
        <a
          key={s.label}
