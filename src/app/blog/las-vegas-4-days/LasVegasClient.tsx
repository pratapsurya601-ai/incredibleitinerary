      ...
      {[
        {
          ...
          href: `mailto:?subject=Las Vegas 4-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Las Vegas in 4 Days — Strip, Grand Canyon &amp; what to actually spend&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
