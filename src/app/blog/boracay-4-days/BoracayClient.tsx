      ...
      {[
        {
          ...
          href: `mailto:?subject=Boracay 4-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Boracay in 4 Days — White Beach, paraw sunsets and Asia&apos;s best kitesurfing&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
