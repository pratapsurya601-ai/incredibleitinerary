      ...
      {[
        {
          ...
          href: `mailto:?subject=Angkor Wat 4-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Angkor Wat in 4 Days — sunrise, Bayon, Ta Prohm, and the temples most people miss&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
