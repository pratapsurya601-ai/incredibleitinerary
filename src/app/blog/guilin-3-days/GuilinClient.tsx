      ...
      {[
        {
          ...
          href: `mailto:?subject=Guilin 3-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Guilin in 3 Days — Li River cruise, karst peaks and Yangshuo cycling&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
