      ...
      {[
        {
          ...
          href: `mailto:?subject=Kotor 3-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Kotor in 3 Days — medieval walls, the Bay of Kotor and Europe&apos;s best-kept Adriatic secret&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
