...
function ShareBar() {
  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      ...
      {[
        { label: "Email", color: "bg-ink text-white", href: `mailto:?subject=Kodaikanal 3-Day Itinerary&body=Check this out: ${pageUrl}` },
        { label: "Twitter", color: "bg-[#1a6fb5] text-white", href: `https://x.com/intent/tweet?text=Kodaikanal in 3 Days guide&url=${pageUrl}` },
      ].map((s) => (
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 p-4 bg-rose-50 border border-rose-200 rounded-xl mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-rose-700 font-light">Stay: Heritage hotel or boutique cottage · ₹1,500–₹3,500/night · Private taxi or bike rental</p>
                  </div>
                </div>
