      ...
      {[
        {
          ...
          href: `mailto:?subject=Barbados 5-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Barbados in 5 Days — flying fish, sea turtles and the world's oldest rum&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
