      ...
      {[
        {
          ...
          href: `mailto:?subject=Edinburgh 4-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Edinburgh in 4 Days — Castle, Arthur's Seat %26 Whisky&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
