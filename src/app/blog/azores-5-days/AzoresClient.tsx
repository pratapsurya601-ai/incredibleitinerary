      ...
      {[
        {
          ...
          href: `mailto:?subject=Azores 5-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Azores in 5 Days — calderas, whale watching and hydrangea roads&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
