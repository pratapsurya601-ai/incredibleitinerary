      ...
      {[
        {
          ...
          href: `mailto:?subject=Mahabalipuram 2-Day Itinerary&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Mahabalipuram in 2 Days guide&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
