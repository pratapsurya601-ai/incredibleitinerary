      ...
      {[
        {
          ...
          href: `mailto:?subject=Colombia 7-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Colombia in 7 Days — Bogotá, Medellín, Cartagena&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
