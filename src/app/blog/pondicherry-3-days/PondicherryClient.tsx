          ...
          <section id="mistakes" className="mb-14">
            ...
            <div className="space-y-3">
              {[
                ...
                { title: "Rushing Auroville in 1 hour", desc: "Auroville needs 3 hours minimum. The Matrimandir alone requires a 1km walk each way. People who spend 45 minutes call it a letdown. People who spend half a day call it transformative. Beyond Matrimandir: Sound Garden at Svaram (no booking needed), Sound Meditation (pre-book), Laboratoires Senteurs for handmade perfumes, and Auroshikha agarbattis — all worth adding if you have time.", icon: "⏰" },
                { title: "Two-tier treatment at Auroville", desc: "Indian visitors — especially younger travellers — sometimes report being treated differently from foreign visitors by local guards at Auroville. It is a known issue worth being aware of. Do not let it put you off visiting, but do not be surprised if it happens.", icon: "⚠️" },
