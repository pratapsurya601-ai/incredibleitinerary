          ...
          <div className="absolute bottom-0 left-0 right-0 px-6 md:px-14 pb-10">
            <div className="max-w-[860px] mx-auto">
              <div className="flex items-center gap-3 mb-4 flex-wrap">
                <span className="bg-gold text-ink text-[0.62rem] tracking-[0.12em] uppercase font-medium px-3 py-1.5 rounded-full">Heritage & Mughal</span>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-parchment">
                    ...
                    <th className="p-3.5 text-xs font-medium text-blue-700 text-center">🌍 Intl.</th>
                    <th className="p-3.5 text-xs font-medium text-purple-700 text-center">🏰 Luxury</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-parchment-2">
                  {[
                    ["🏨 Accommodation (7N)", "₹4,200–₹10,500",  "₹35,000–₹70,000",  "₹21,000–₹42,000",   "₹1,75,000–₹4,55,000"],
                    ["🍽 Food & Drinks",      "₹3,500–₹6,000",   "₹10,000–₹20,000",  "₹12,000–₹20,000",   "₹28,000–₹56,000"],
                    ["🚆 Transport",          "₹3,000–₹5,000",   "₹12,000–₹18,000",  "₹10,000–₹16,000",   "₹20,000–₹40,000"],
                    ["🎯 Entries + Guides",   "₹3,500–₹5,500",   "₹8,000–₹14,000",   "₹8,000–₹14,000",    "₹20,000–₹50,000"],
                    ["🛍 Shopping",           "₹2,000–₹5,000",   "₹5,000–₹15,000",   "₹5,000–₹15,000",    "₹20,000+"],
                    ["TOTAL (per person)",    "₹18,000–₹28,000", "₹27,500–₹42,500",  "₹20,000–₹35,000",   "₹1,22,000+"],
                  ].map(([cat, ...vals]) => (
