      ...
      {[
        {
          ...
          href: `mailto:?subject=Kotor Montenegro 3-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Kotor Montenegro in 3 Days — medieval walls, Bay of Kotor and Our Lady of the Rocks&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
