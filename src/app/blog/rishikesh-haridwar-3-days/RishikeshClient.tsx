    ...
    <main className="bg-cream min-h-screen">
      <div className="relative h-[60vh] min-h-[420px] overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 px-6 md:px-14 pb-10"><div className="max-w-[860px] mx-auto">
          <div className="flex items-center gap-3 mb-4 flex-wrap"><span className="bg-orange-600 text-white text-xs tracking-[0.12em] uppercase font-medium px-3 py-1.5 rounded-full">Yoga Capital of the World</span><span className="text-white/60 text-xs">March 2026</span><span className="text-white/50">·</span><span className="text-white/60 text-xs">11 min read</span></div>
      ...
      <div className="max-w-[860px] mx-auto px-6 md:px-8 pt-10 pb-20">
        ...
        <section id="howtoreach" className="mb-14">
          ...
          <div className="space-y-3">
            {[{i:"🚌",t:"Overnight bus (best value)",d:"Delhi Kashmere Gate → Rishikesh/Haridwar: Rs.400–Rs.800, 6–7hrs. Depart 10pm, arrive 5am. Book on redbus.in.",b:"Best value",c:"bg-green-50 border-green-200"},{i:"🚂",t:"Train to Haridwar",d:"Delhi → Haridwar: 4–5hrs, Rs.200–Rs.500. Shatabdi is fastest. Then local bus to Rishikesh (Rs.50–Rs.150, 45min).",b:"Comfortable",c:"bg-amber-50 border-amber-200"},{i:"🚗",t:"Drive from Delhi",d:"249km via NH58, 5–6hrs. Straightforward until Haridwar, then scenic mountain road.",b:"Flexible",c:"bg-parchment border-parchment-2"}].map(t=><div key={t.t} className={`rounded-xl p-4 border ${t.c}`}><div className="flex items-start gap-3"><span className="text-2xl flex-shrink-0">{t.i}</span><div className="flex-1"><div className="flex items-center gap-2 mb-1 flex-wrap"><p className="font-semibold text-sm text-ink">{t.t}</p><span className="text-xs bg-white/70 text-muted px-2.5 py-1 rounded-full border border-white/50">{t.b}</span></div><p className="text-xs text-gray-700 font-light leading-relaxed">{t.d}</p></div></div></div>)}
          </div>
        </section>

        <section id="itinerary" className="mb-14">
          <h2 className="font-serif text-[1.9rem] font-light text-ink mb-6">📅 3-Day Itinerary</h2>
          <D day="Day 1" title="Arrive Haridwar — Ganga Aarti Evening" cost="₹800–₹1,500" items={["Arrive Haridwar morning. Check in near Har Ki Pauri (Rs.500–Rs.2,500/night). Walk to ghats — 10 minutes from most accommodation.","Har Ki Pauri at noon — walk the ghats, watch pilgrims bathing, see the Charanamrit footprint temple. Don't hire a pandit unless you want to — they're persistent but optional.","Mansa Devi Temple by ropeway (Rs.126 return as of early 2026) — hilltop overlooking the Ganges. Go at 3pm. The sunset views from up here over the river and the city are genuinely spectacular.","Evening Ganga Aarti at Har Ki Pauri — timing varies by season: winter (Oct–Feb) around 6:00–6:30pm, summer (Mar–Sep) around 7:00–7:30pm. Check sunset time for your date and ARRIVE 45 MINUTES EARLY for a front spot. 7 priests swing fire lamps as 50,000 people watch. Buy a diya (Rs.20) to float on the river. Free entry.","Morning Aarti tip: Har Ki Pauri also has a morning Ganga Aarti at dawn (around 5:30–6am). Far fewer crowds — only a few hundred pilgrims. If you&apos;re an early riser, this is more peaceful and more spiritually authentic than the famous evening ceremony.","Dinner at Mohan Ji Puri Wale — famous puri sabzi, Rs.60–Rs.80. Best meal in Haridwar."]}/>
          <D day="Day 2" title="Move to Rishikesh — Rafting + Beatles Ashram" cost="₹1,200–₹2,500" items={["Morning: local bus to Rishikesh (Rs.50–Rs.80, 45min). Check in near Laxman Jhula (Rs.500–Rs.1,500/night).","9am: White water rafting — 16km Brahmpuri → Rishikesh route, Rs.600–Rs.900/person. Grade 3 rapids including Roller Coaster and Three Blind Mice. 2.5–3 hours.","Afternoon: Beatles Ashram (Rs.600 entry as of early 2026). The Maharishi's abandoned meditation centre, covered in vivid, slightly eerie murals. Dome-shaped meditation cells where the Beatles composed White Album songs still stand. The silence inside the domes is almost unsettling.","Evening: Laxman Jhula suspension bridge at sunset — walk across for wide-open river views with the foothills behind. Triambakeshwar Temple at the far end. Heads up: Ram Jhula gets painfully crowded after 10am — go at 7am or don't bother.","Dinner at Little Buddha Cafe (rooftop, river view) or Freedom Cafe — Rs.150–Rs.350."]}/>
          <D day="Day 3" title="Sunrise Yoga + Neelkanth Temple + Depart" cost="₹600–₹1,200" items={["6am: Sunrise yoga at Parmarth Niketan Ashram — free morning yoga on the riverbank. Mat rental Rs.50. The Ganges at dawn, mountains in the mist — there's a reason people keep coming back here.","Neelkanth Mahadev Temple (32km, Rs.400–Rs.600 by shared jeep) — jungle temple where Shiva drank the cosmic poison. Very atmospheric on a weekday.","Alternative: Kunjapuri Temple (25km) — panoramic Himalayan view, much less visited. On a clear morning you can see Gangotri glacier.","Return Rishikesh noon. Last coffee at German Bakery. Bus/train back to Delhi afternoon."]}/>
        </section>
        ...
        <section id="budget" className="mb-14">
          ...
          <div className="overflow-x-auto rounded-xl border border-parchment-2 shadow-sm">
            <table className="w-full text-sm"><thead><tr className="bg-ink"><th className="text-left p-3.5 text-xs font-medium text-white/70">Category</th><th className="p-3.5 text-xs font-medium text-amber-300 text-center">Budget</th><th className="p-3.5 text-xs font-medium text-rose-300 text-center">Mid-Range</th><th className="p-3.5 text-xs font-medium text-purple-300 text-center">Comfortable</th></tr></thead>
        ...
        <AffiliateBlock destination="Rishikesh Uttarakhand" hotels={[{name:"Taj Rishikesh Resort & Spa",type:"Luxury · Ganges view",price:"From ₹12,000/night",rating:"5",badge:"Most luxurious",url:"https://www.booking.com/hotel/in/taj-rishikesh.html?aid=2820480"},{name:"Zostel Rishikesh",type:"Hostel · Laxman Jhula",price:"From ₹400/bed",rating:"4",badge:"Best budget",url:"https://www.booking.com/hotel/in/zostel-rishikesh.html?aid=2820480"},{name:"Brijwasi Royal Haridwar",type:"Hotel · Har Ki Pauri",price:"From ₹2,000/night",rating:"4",badge:"Best Haridwar",url:"https://www.booking.com/hotel/in/brijwasi-royal-haridwar.html?aid=2820480"},{name:"Aloha on the Ganges",type:"Resort · Rishikesh",price:"From ₹4,500/night",rating:"4",badge:"River views",url:"https://www.booking.com/hotel/in/aloha-on-the-ganges.html?aid=2820480"}]} activities={[{name:"Rishikesh White Water Rafting 16km",duration:"3hrs",price:"From ₹600/person",badge:"Must do",url:"https://www.getyourguide.com/s/?q=rishikesh&partner_id=PSZA5UI"},{name:"Haridwar Ganga Aarti Evening Tour",duration:"3hrs",price:"From ₹500/person",badge:"Iconic",url:"https://www.getyourguide.com/s/?q=rishikesh&partner_id=PSZA5UI"},{name:"Sunrise Yoga Class Rishikesh",duration:"1.5hrs",price:"From ₹300/person",url:"https://www.getyourguide.com/s/?q=rishikesh&partner_id=PSZA5UI"},{name:"Beatles Ashram + Rafting Combo",duration:"Full day",price:"From ₹1,200/person",url:"https://www.getyourguide.com/s/?q=rishikesh&partner_id=PSZA5UI"}]}/>
        ...
        <div className="mb-14 bg-ink rounded-2xl p-8 text-center">
          ...
          <p className="text-sm text-white/80 font-light mb-7 max-w-[380px] mx-auto leading-relaxed">Tell us your dates, group size and budget — personalised Rishikesh + Haridwar plan in 24 hours. Free.</p>
