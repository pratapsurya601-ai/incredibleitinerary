    ...
    <main className="bg-cream min-h-screen">
      ...
      <div className="max-w-[860px] mx-auto px-6 md:px-8 pt-10 pb-20">
        ...
        <section id="honest" className="mb-14">
          ...
          <p className="text-sm text-muted font-light leading-relaxed mb-4">Haridwar is one of the four Kumbh Mela sites. The evening Ganga Aarti at Har Ki Pauri — 50,000 people watching priests swing fire over the river — is one of those scenes that hits you in the chest even if you're not religious. The Ganga Aarti at Triveni Ghat in Haridwar hit differently than Varanasi for me — smaller, more intimate, and you can actually get close enough to feel the heat from the lamps.</p>
