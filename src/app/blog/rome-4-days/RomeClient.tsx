      ...
      {[
        {
          ...
          href: `mailto:?subject=Rome 4-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Rome in 4 Days — Colosseum, Vatican, Trastevere and the real Roman food scene&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
