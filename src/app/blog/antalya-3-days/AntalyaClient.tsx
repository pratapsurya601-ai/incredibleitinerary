      ...
      {[
        {
          ...
          href: `mailto:?subject=Antalya 3-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Antalya in 3 Days — Kalei%C3%A7i, Aspendos and the Turkish Riviera&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
