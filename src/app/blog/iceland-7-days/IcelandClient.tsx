      ...
      {[
        {
          ...
          href: `mailto:?subject=Iceland 7-Day Ring Road Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Iceland in 7 Days — Ring Road, Northern Lights, Glaciers&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
