...
function ShareBar() {
  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      ...
      {[
        { label: "Email", color: "bg-ink text-white", href: `mailto:?subject=Pachmarhi 3-Day Guide&body=Check this out: ${pageUrl}` },
        { label: "Twitter", color: "bg-[#1a6fb5] text-white", href: `https://x.com/intent/tweet?text=Pachmarhi in 3 Days — Satpura Waterfalls, Pandava Caves & Churchill's Viewpoint&url=${pageUrl}` },
      ].map((s) => (
