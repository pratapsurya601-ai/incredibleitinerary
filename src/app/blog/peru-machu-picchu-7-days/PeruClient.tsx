      ...
      {[
        {
          ...
          href: `mailto:?subject=Peru 7-Day Machu Picchu Guide&body=Check this out: ${typeof window !== "undefined" ? window.location.href : ""}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1DA1F2] text-white",
          href: `https://x.com/intent/tweet?text=Peru in 7 Days — Machu Picchu, Cusco, Sacred Valley and Lima's world-class food&url=${typeof window !== "undefined" ? window.location.href : ""}`,
        },
      ].map((s) => (
        <a
          key={s.label}
