      ...
      {[
        {
          ...
          href: `mailto:?subject=Jamaica 5-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Jamaica in 5 Days — Seven Mile Beach, Rick%27s Cafe cliff diving, Blue Mountains coffee&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
