...
function ShareBar() {
  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      ...
      <a href={`mailto:?subject=Andaman Islands 5-Day Guide&body=${pageUrl}`} className="bg-ink text-white text-[0.65rem] font-medium tracking-wide uppercase px-3 py-1.5 rounded-full hover:opacity-80 transition-opacity">Email</a>
      <a href={`https://x.com/intent/tweet?text=Andaman%20Islands%205-Day%20Guide&url=${pageUrl}`} target="_blank" rel="noopener noreferrer" className="bg-[#1a6fb5] text-white text-[0.65rem] font-medium tracking-wide uppercase px-3 py-1.5 rounded-full hover:opacity-80 transition-opacity">Twitter</a>
      ...
      <main id="main-content" className="bg-cream min-h-screen">
          ...
          <div className="absolute bottom-0 left-0 right-0 px-6 md:px-14 pb-10">
            <div className="max-w-[860px] mx-auto">
              <div className="flex items-center gap-3 mb-4 flex-wrap">
                <span className="bg-teal text-white text-xs tracking-[0.12em] uppercase font-medium px-3 py-1.5 rounded-full">Asia&apos;s Best Beach</span>
        ...
        <div className="max-w-[860px] mx-auto px-6 md:px-8 pt-10 pb-20">
            ...
            <div className="overflow-x-auto rounded-xl border border-parchment-2 shadow-sm">
              <table className="w-full text-sm">
                <thead><tr className="bg-ink">
                  ...
                  <th className="p-3.5 text-xs font-medium text-teal-300 text-center">💑 Couple</th>
                  <th className="p-3.5 text-xs font-medium text-blue-300 text-center">🤿 Adventure</th>
                  <th className="p-3.5 text-xs font-medium text-green-300 text-center">👨‍👩‍👧 Family</th>
                </tr></thead>
          ...
          <div className="max-w-[860px] mx-auto px-6 md:px-8 mb-12">
            <h2 className="font-serif text-xl font-light text-ink mb-4">Plan your Andaman trip</h2>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {[
                { href: "/blog/best-time-to-visit-andaman", label: "Best time to visit", icon: "🗓️" },
                { href: "/blog/andaman-trip-cost-couple", label: "Trip cost breakdown", icon: "💰" },
                { href: "/blog/how-to-reach-andaman", label: "How to get there", icon: "✈️" },
                { href: "/blog/andaman-travel-tips", label: "Travel tips", icon: "📋" },
              ].map((item) => (
