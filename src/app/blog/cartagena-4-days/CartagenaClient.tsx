      ...
      {[
        {
          ...
          href: `mailto:?subject=Cartagena 4-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Cartagena Colombia in 4 Days — walled city, Rosario Islands, Getsemaní&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
