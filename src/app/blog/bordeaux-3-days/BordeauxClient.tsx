      ...
      {[
        {
          ...
          href: `mailto:?subject=Bordeaux 3-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Bordeaux in 3 Days — Miroir d%27Eau%2C Saint-Émilion and La Cité du Vin&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
