...
function ShareBar() {
  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      ...
      {[
        { label: "Email", color: "bg-ink text-white", href: `mailto:?subject=Ubud 3-Day Itinerary&body=Check this out: ${typeof window !== "undefined" ? window.location.href : ""}` },
        { label: "Twitter", color: "bg-[#1DA1F2] text-white", href: `https://twitter.com/intent/tweet?text=Ubud in 3 Days guide&url=${typeof window !== "undefined" ? window.location.href : ""}` },
      ].map((s) => (
        ...
        <div className="max-w-[860px] mx-auto px-6 md:px-8 pt-10 pb-20">
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-parchment">
                    <th className="text-left p-3.5 text-xs font-medium text-muted">Category (3 days)</th>
          ...
          <AffiliateBlock
            ...
            activities={[
              ...
              { name: "Balinese Cooking Class", duration: "5 hours", price: "From Rp400k/person (~$25)", badge: "Cultural", url: "https://www.getyourguide.com/bali-l347/cooking/?partner_id=PSZA5UI" },
