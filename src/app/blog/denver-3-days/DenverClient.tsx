      ...
      {[
        {
          ...
          href: `mailto:?subject=Denver 3-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Denver in 3 Days — Red Rocks, Rocky Mountain NP and Colorado craft beer&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
