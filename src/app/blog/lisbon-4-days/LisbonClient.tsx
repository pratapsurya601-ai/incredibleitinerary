      ...
      {[
        {
          ...
          href: `mailto:?subject=Lisbon 4-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Lisbon in 4 Days — trams, fado, Sintra and pastéis de nata&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
