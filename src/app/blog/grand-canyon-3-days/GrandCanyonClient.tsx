      ...
      {[
        {
          ...
          href: `mailto:?subject=Grand Canyon 3-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Grand Canyon in 3 Days — hikes, viewpoints and the Colorado River&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
