  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      ...
      {[
        ...
        { label: "Twitter", color: "bg-[#1DA1F2] text-white", href: `https://x.com/intent/tweet?text=Dubai in 4 Days guide&url=${typeof window !== "undefined" ? window.location.href : ""}` },
      ].map((s) => (
      ...
      <main className="bg-cream min-h-screen">
        ...
        <div className="max-w-[860px] mx-auto px-6 md:px-8 pt-10 pb-20">
          ...
          <AffiliateBlock
            ...
            activities={[
              { name: "Burj Khalifa At the Top", duration: "1.5 hours", price: "From AED 169", badge: "Must do", url: "https://www.getyourguide.com/s/?q=dubai&partner_id=PSZA5UI" },
              { name: "Desert Safari with BBQ Dinner", duration: "6 hours", price: "From AED 200", badge: "Essential", url: "https://www.getyourguide.com/s/?q=dubai&partner_id=PSZA5UI" },
              { name: "Old Dubai Heritage Walking Tour", duration: "3 hours", price: "From AED 120", badge: "Cultural", url: "https://www.getyourguide.com/s/?q=dubai&partner_id=PSZA5UI" },
              { name: "Dubai Marina Yacht Cruise", duration: "2 hours", price: "From AED 150", url: "https://www.getyourguide.com/s/?q=dubai&partner_id=PSZA5UI" },
            ]}
          />
