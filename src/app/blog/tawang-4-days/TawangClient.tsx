...
function ShareBar() {
  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      ...
      {[
        { label: "Email", color: "bg-ink text-white", href: `mailto:?subject=Tawang 4-Day Itinerary&body=Check this out: ${pageUrl}` },
        { label: "Twitter", color: "bg-[#1a6fb5] text-white", href: `https://x.com/intent/tweet?text=Tawang in 4 Days guide&url=${pageUrl}` },
      ].map((s) => (
      ...
      <main id="main-content" className="bg-cream min-h-screen">
        ...
        <div className="max-w-[860px] mx-auto px-6 md:px-8 pt-10 pb-20">
          ...
          <AffiliateBlock
            ...
            activities={[
              { name: "Tawang Monastery Guided Tour", duration: "3 hours", price: "From ₹500/person", badge: "Must do", url: "https://www.getyourguide.com/s/?q=tawang&partner_id=PSZA5UI" },
              { name: "Bumla Pass Border Excursion", duration: "5 hours", price: "From ₹1,000/person", badge: "Unique", url: "https://www.getyourguide.com/s/?q=tawang&partner_id=PSZA5UI" },
              { name: "Madhuri Lake & PTSO Lake Circuit", duration: "4 hours", price: "From ₹800/person", url: "https://www.getyourguide.com/s/?q=tawang&partner_id=PSZA5UI" },
              { name: "Sela Pass Photography Tour", duration: "Full day", price: "From ₹2,000/person", url: "https://www.getyourguide.com/s/?q=tawang&partner_id=PSZA5UI" },
            ]}
