  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      ...
      {[
        ...
        { label: "Twitter", color: "bg-[#1DA1F2] text-white", href: `https://twitter.com/intent/tweet?text=Goa in 3 Days guide&url=${typeof window !== "undefined" ? window.location.href : ""}` },
      ].map((s) => (
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-parchment">
                    ...
                    <th className="p-3.5 text-xs font-medium text-purple-700 text-center">🎉 Party</th>
