...
export const metadata: Metadata = {
  title: "Chiang Mai in 4 Days: Complete Itinerary Guide (Budget to Luxury, 2026)",
  description:
    "3 complete Chiang Mai plans — Budget, Mid-Range, Luxury — with Doi Suthep, ethical elephant sanctuaries, night markets, cooking classes and real costs in Thai Baht.",
  keywords: [
  ...
  openGraph: {
    title: "Chiang Mai in 4 Days: Budget to Luxury Itinerary 2026",
    description:
  ...
  twitter: {
    ...
    title: "Chiang Mai in 4 Days: The Only Guide You Need (2026)",
