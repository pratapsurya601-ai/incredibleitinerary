      ...
      {[
        {
          ...
          href: `mailto:?subject=India Budget Travel Guide 2026&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=India Budget Travel Guide — ₹1,500/day formula for the Golden Triangle and beyond&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
