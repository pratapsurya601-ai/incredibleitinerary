      ...
      {[
        {
          ...
          href: `mailto:?subject=Langkawi 3-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Langkawi in 3 Days — cable car, mangrove eagles and duty-free rum&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
