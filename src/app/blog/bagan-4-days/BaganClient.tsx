      ...
      {[
        {
          ...
          href: `mailto:?subject=Bagan 4-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Bagan in 4 Days — 2,000 temples, e-bikes and hot air balloons over Myanmar&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
