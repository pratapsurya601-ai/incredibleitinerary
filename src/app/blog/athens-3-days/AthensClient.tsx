      ...
      {[
        {
          ...
          href: `mailto:?subject=Athens 3-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Athens in 3 Days — Acropolis, Plaka and rooftop bars with Parthenon views&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
