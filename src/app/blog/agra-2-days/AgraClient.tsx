...
function ShareBar() {
  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      ...
      {[
        { label: "Email", color: "bg-ink text-white", href: `mailto:?subject=Agra 2-Day Itinerary&body=Check this out: ${pageUrl}` },
        { label: "Twitter", color: "bg-[#1a6fb5] text-white", href: `https://x.com/intent/tweet?text=Agra in 2 Days guide&url=${pageUrl}` },
      ].map((s) => (
      ...
      <main id="main-content" className="bg-cream min-h-screen">
        ...
        <div className="max-w-[860px] mx-auto px-6 md:px-8 pt-10 pb-20">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 p-4 bg-rose-50 border border-rose-200 rounded-xl mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-rose-700 font-light">Stay: 5-star with Taj view · ₹12,000–₹35,000/night · Private car + guide</p>
                  </div>
                </div>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-ink">
                    ...
                    <th className="p-3.5 text-xs font-medium text-orange-300 text-center">\uD83C\uDFDB\uFE0F Heritage</th>
          ...
          <div className="max-w-[860px] mx-auto px-6 md:px-8 mb-12">
            <h2 className="font-serif text-xl font-light text-ink mb-4">Plan your Agra trip</h2>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {[
                { href: "/blog/best-time-to-visit-agra", label: "Best time to visit", icon: "🗓️" },
                { href: "/blog/agra-trip-cost-couple", label: "Trip cost breakdown", icon: "💰" },
                { href: "/blog/how-to-reach-agra", label: "How to get there", icon: "✈️" },
                { href: "/blog/agra-travel-tips", label: "Travel tips", icon: "📋" },
              ].map((item) => (
