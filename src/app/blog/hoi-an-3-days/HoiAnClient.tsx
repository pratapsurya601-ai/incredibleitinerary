      ...
      {[
        {
          ...
          href: `mailto:?subject=Hoi An 3-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Hoi An in 3 Days — lanterns, tailors and the Ancient Town&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
