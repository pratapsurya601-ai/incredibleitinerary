...
function ShareBar() {
  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      ...
      {[
        { label: "Email", color: "bg-ink text-white", href: `mailto:?subject=Lombok 4-Day Itinerary&body=Check this out: ${pageUrl}` },
        { label: "Twitter", color: "bg-[#1a6fb5] text-white", href: `https://x.com/intent/tweet?text=Lombok in 4 Days guide&url=${pageUrl}` },
      ].map((s) => (
      ...
      <main id="main-content" className="bg-cream min-h-screen">
        ...
        <div className="max-w-[860px] mx-auto px-6 md:px-8 pt-10 pb-20">
          ...
          <AffiliateBlock
            ...
            activities={[
              { name: "Gili Islands Snorkelling Trip", duration: "Full day", price: "From Rp150k/person (~$9)", badge: "Must do", url: "https://www.getyourguide.com/s/?q=lombok&partner_id=PSZA5UI" },
              { name: "South Lombok Beach Tour", duration: "Full day", price: "From Rp400k/person (~$25)", badge: "Scenic", url: "https://www.getyourguide.com/s/?q=lombok&partner_id=PSZA5UI" },
              { name: "Mount Rinjani 2-Day Trek", duration: "2 days", price: "From Rp2M/person (~$127)", url: "https://www.getyourguide.com/s/?q=lombok&partner_id=PSZA5UI" },
              { name: "Sendang Gile Waterfall Tour", duration: "Half day", price: "From Rp200k/person (~$13)", url: "https://www.getyourguide.com/s/?q=lombok&partner_id=PSZA5UI" },
            ]}
