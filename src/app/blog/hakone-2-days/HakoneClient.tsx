      ...
      {[
        {
          ...
          href: `mailto:?subject=Hakone 2-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Hakone in 2 Days — Mount Fuji views, Owakudani black eggs and ryokan onsen&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
