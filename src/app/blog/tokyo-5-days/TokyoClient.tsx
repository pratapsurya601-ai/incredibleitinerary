      ...
      {[
        {
          ...
          href: `mailto:?subject=Tokyo 5-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Tokyo in 5 Days — neon, temples, ramen and the world's best metro&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
