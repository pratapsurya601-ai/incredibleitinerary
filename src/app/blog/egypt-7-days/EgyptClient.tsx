      ...
      {[
        {
          ...
          href: `mailto:?subject=Egypt 7-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Egypt in 7 Days — Pyramids, Luxor, Nile Cruise and Abu Simbel&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
