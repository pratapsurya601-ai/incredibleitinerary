      ...
      {[
        {
          ...
          href: `mailto:?subject=Lalibela Ethiopia 5-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Lalibela Ethiopia in 5 Days — 11 rock-hewn churches, Timkat Festival, and one of Africa%27s greatest wonders&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
