      ...
      {[
        {
          ...
          href: `mailto:?subject=Belfast 4-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Belfast in 4 Days — Titanic Museum, murals and Giant%27s Causeway&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
