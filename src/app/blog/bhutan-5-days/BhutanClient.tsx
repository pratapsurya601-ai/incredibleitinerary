      ...
      {[
        {
          ...
          href: `mailto:?subject=Bhutan 5-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Bhutan in 5 Days — Tiger%27s Nest, Punakha Dzong and the Himalayan Kingdom&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
