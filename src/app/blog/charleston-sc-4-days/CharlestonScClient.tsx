      ...
      {[
        {
          ...
          href: `mailto:?subject=Charleston SC 4-Day Guide&body=Check this out: ${typeof window !== "undefined" ? window.location.href : ""}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1DA1F2] text-white",
          href: `https://x.com/intent/tweet?text=Charleston SC in 4 Days — Rainbow Row, Fort Sumter, and the best shrimp and grits in the South&url=${typeof window !== "undefined" ? window.location.href : ""}`,
        },
      ].map((s) => (
        <a
          key={s.label}
