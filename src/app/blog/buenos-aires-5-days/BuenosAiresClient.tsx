      ...
      {[
        {
          ...
          href: `mailto:?subject=Buenos Aires 5-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Buenos Aires in 5 Days — tango, steak, Recoleta and La Boca&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
