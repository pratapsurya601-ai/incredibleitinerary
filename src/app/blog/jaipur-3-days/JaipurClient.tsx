...
function ShareBar() {
  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      ...
      {[
        { label: "Email", color: "bg-ink text-white", href: `mailto:?subject=Jaipur 3-Day Itinerary&body=Check this out: ${pageUrl}` },
        { label: "Twitter", color: "bg-[#1a6fb5] text-white", href: `https://x.com/intent/tweet?text=Jaipur in 3 Days guide&url=${pageUrl}` },
      ].map((s) => (
      ...
      <main id="main-content" className="bg-cream min-h-screen">
        ...
        <div className="max-w-[860px] mx-auto px-6 md:px-8 pt-10 pb-20">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 p-4 bg-rose-50 border border-rose-200 rounded-xl mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-rose-700 font-light">Stay: Heritage haveli or boutique hotel {"·"} {"₹"}2,000{"–"}{"₹"}5,000/night {"·"} Transport: Full-day cab</p>
                  </div>
                </div>
          ...
          <div className="max-w-[860px] mx-auto px-6 md:px-8 mb-12">
            <h2 className="font-serif text-xl font-light text-ink mb-4">Plan your Jaipur trip</h2>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {[
                { href: "/blog/best-time-to-visit-jaipur", label: "Best time to visit", icon: "🗓️" },
                { href: "/blog/jaipur-trip-cost-couple", label: "Trip cost breakdown", icon: "💰" },
                { href: "/blog/how-to-reach-jaipur", label: "How to get there", icon: "✈️" },
                { href: "/blog/jaipur-travel-tips", label: "Travel tips", icon: "📋" },
              ].map((item) => (
