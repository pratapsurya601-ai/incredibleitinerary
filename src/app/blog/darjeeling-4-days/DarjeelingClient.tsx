...
function ShareBar() {
  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      ...
      {[
        { label: "Email", color: "bg-ink text-white", href: `mailto:?subject=Darjeeling 4-Day Itinerary&body=Check this out: ${pageUrl}` },
        { label: "Twitter", color: "bg-[#1a6fb5] text-white", href: `https://x.com/intent/tweet?text=Darjeeling in 4 Days guide&url=${pageUrl}` },
      ].map((s) => (
      ...
      <main id="main-content" className="bg-cream min-h-screen">
        ...
        <div className="max-w-[860px] mx-auto px-6 md:px-8 pt-10 pb-20">
          ...
          <AffiliateBlock
            ...
            activities={[
              { name: "Tiger Hill Sunrise Tour", duration: "4 hours", price: "From ₹500/person", badge: "Must do", url: "https://www.getyourguide.com/s/?q=darjeeling&partner_id=PSZA5UI" },
              { name: "Darjeeling Toy Train Joyride", duration: "40 minutes", price: "From ₹800/person", badge: "Heritage", url: "https://www.getyourguide.com/s/?q=darjeeling&partner_id=PSZA5UI" },
              { name: "Happy Valley Tea Estate Tour", duration: "2 hours", price: "Free", url: "https://www.getyourguide.com/s/?q=darjeeling&partner_id=PSZA5UI" },
              { name: "Full Day Kalimpong Excursion", duration: "Full day", price: "From ₹2,500/person", url: "https://www.getyourguide.com/s/?q=darjeeling&partner_id=PSZA5UI" },
            ]}
