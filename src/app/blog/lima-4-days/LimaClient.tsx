      ...
      {[
        {
          ...
          href: `mailto:?subject=Lima 4-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Lima in 4 Days — ceviche, cliffs and the world's best restaurants&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
