      ...
      {[
        {
          ...
          href: `mailto:?subject=Malaysia 7-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Malaysia in 7 Days — Petronas Towers, Penang street food &amp; Langkawi beaches&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
