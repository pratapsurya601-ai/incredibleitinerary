      ...
      {[
        {
          ...
          href: `mailto:?subject=Bath 2-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Bath in 2 Days — Roman Baths, Thermae Spa and Georgian architecture&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
