  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      ...
      {[
        ...
        { label: "Twitter", color: "bg-[#1DA1F2] text-white", href: `https://x.com/intent/tweet?text=Sundarbans in 3 Days safari guide&url=${typeof window !== "undefined" ? window.location.href : ""}` },
      ].map((s) => (
