  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Indian passport holders can visit approximately 57–62 countries without obtaining a visa in advance as of 2026. This includes countries with true visa-free entry (like Nepal, Maldives, Mauritius, Seychelles, Fiji) and countries with visa on arrival or e-visa on arrival (like Thailand, Indonesia, Sri Lanka, UAE, Kenya, Malaysia). The exact count varies based on how you classify e-visa vs visa on arrival.",
      },
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No — Indians require a UAE visa in advance. However, the process is easy and fast: you can apply online through icp.gov.ae, directly with Emirates/IndiGo/Air India (they offer visa on booking), or via travel agents. The UAE tourist visa costs ₹3,000–₹5,000 and takes 3–5 business days. UAE also offers visa on arrival for certain categories (holders of US/UK/EU Schengen visas).",
      },
    },
    {
      "@type": "Question",
