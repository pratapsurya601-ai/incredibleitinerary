      ...
      {[
        {
          ...
          href: `mailto:?subject=Hamburg 3-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Hamburg in 3 Days — Speicherstadt, Elbphilharmonie and the Sunday Fischmarkt&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
