      ...
      {[
        {
          ...
          href: `mailto:?subject=Prague 4-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Prague in 4 Days — castle, Charles Bridge and the best beer in Europe&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
