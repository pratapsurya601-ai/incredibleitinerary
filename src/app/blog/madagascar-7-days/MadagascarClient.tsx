      ...
      {[
        {
          ...
          href: `mailto:?subject=Madagascar 7-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Madagascar in 7 Days — lemurs, baobabs, tsingy and pristine beaches&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
