      ...
      {[
        {
          ...
          href: `mailto:?subject=Belgrade 3-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Belgrade in 3 Days — Kalemegdan, splavovi nightlife and the most affordable capital in Europe&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
