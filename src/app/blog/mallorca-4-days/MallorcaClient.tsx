      ...
      {[
        {
          ...
          href: `mailto:?subject=Mallorca 4-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Mallorca in 4 Days — cathedral, tramuntana cliffs and the Caves of Drach&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
