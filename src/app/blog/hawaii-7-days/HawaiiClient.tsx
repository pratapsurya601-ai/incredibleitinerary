      ...
      {[
        {
          ...
          href: `mailto:?subject=Hawaii 7-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Hawaii in 7 Days — Oahu, Maui %26 Big Island complete guide&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
