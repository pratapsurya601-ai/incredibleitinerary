      ...
      {[
        {
          ...
          href: `mailto:?subject=Bangkok 4-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Bangkok in 4 Days — temples, street food and the real city&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
