...
function ShareBar() {
  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      ...
      {[
        { label: "Email", color: "bg-ink text-white", href: `mailto:?subject=Mount Abu 2-Day Itinerary&body=Check this out: ${typeof window !== "undefined" ? window.location.href : ""}` },
        { label: "Twitter", color: "bg-[#1DA1F2] text-white", href: `https://twitter.com/intent/tweet?text=Mount Abu in 2 Days guide&url=${typeof window !== "undefined" ? window.location.href : ""}` },
      ].map((s) => (
