      ...
      {[
        {
          ...
          href: `mailto:?subject=Cyprus 5-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Cyprus in 5 Days — Paphos ruins, Troodos mountains, and the world's last divided capital&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
