      ...
      {[
        {
          ...
          href: `mailto:?subject=Cologne 3-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Cologne in 3 Days — Cathedral, Kölsch beer and the Rhine&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
