...
function ShareBar() {
  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      ...
      {[
        { label: "Email", color: "bg-ink text-white", href: `mailto:?subject=Muscat 3-Day Itinerary&body=Check this out: ${pageUrl}` },
        { label: "Twitter", color: "bg-[#1a6fb5] text-white", href: `https://x.com/intent/tweet?text=Muscat in 3 Days guide&url=${pageUrl}` },
