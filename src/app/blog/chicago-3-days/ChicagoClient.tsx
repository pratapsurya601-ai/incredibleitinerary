      ...
      {[
        {
          ...
          href: `mailto:?subject=Chicago 3-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Chicago in 3 Days — architecture, deep dish and the Bean&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
