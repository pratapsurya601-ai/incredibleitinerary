      ...
      {[
        {
          ...
          href: `mailto:?subject=Fez Morocco 3-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Fez Morocco in 3 Days — UNESCO medina, ancient tanneries and the world's oldest university&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
