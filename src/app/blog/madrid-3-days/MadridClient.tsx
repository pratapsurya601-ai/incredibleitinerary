          ...
          <div className="absolute bottom-0 left-0 right-0 px-6 md:px-14 pb-10">
            <div className="max-w-[860px] mx-auto">
              <div className="flex items-center gap-3 mb-4 flex-wrap">
                <span className="bg-gold text-ink text-[0.62rem] tracking-[0.12em] uppercase font-medium px-3 py-1.5 rounded-full">Art & Culture</span>
        ...
        <div className="max-w-[860px] mx-auto px-6 md:px-8 pt-10 pb-20">
          ...
          <AffiliateBlock
            ...
            activities={[
              ...
              { name: "Toledo Full Day Trip", duration: "8 hours", price: "From \u20AC25", badge: "Day trip", url: "https://www.getyourguide.com/madrid-l47/toledo/?partner_id=PSZA5UI" },
              { name: "Flamenco Show + Tapas Dinner", duration: "3 hours", price: "From \u20AC55", badge: "Cultural", url: "https://www.getyourguide.com/madrid-l47/flamenco/?partner_id=PSZA5UI" },
              { name: "Madrid Tapas Walking Tour", duration: "3 hours", price: "From \u20AC35", url: "https://www.getyourguide.com/madrid-l47/tapas/?partner_id=PSZA5UI" },
            ]}
          />
