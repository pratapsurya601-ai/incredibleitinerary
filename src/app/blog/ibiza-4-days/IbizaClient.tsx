      ...
      {[
        {
          ...
          href: `mailto:?subject=Ibiza 4-Day Guide&body=Check this out: ${pageUrl}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1a6fb5] text-white",
          href: `https://x.com/intent/tweet?text=Ibiza in 4 Days — Dalt Vila, Café del Mar, clubs and Formentera&url=${pageUrl}`,
        },
      ].map((s) => (
        <a
          key={s.label}
