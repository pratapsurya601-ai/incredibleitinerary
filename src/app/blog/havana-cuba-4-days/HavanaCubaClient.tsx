      ...
      {[
        {
          ...
          href: `mailto:?subject=Havana Cuba 4-Day Guide&body=Check this out: ${typeof window !== "undefined" ? window.location.href : ""}`,
        },
        {
          label: "Twitter",
          color: "bg-[#1DA1F2] text-white",
          href: `https://x.com/intent/tweet?text=Havana in 4 Days — 1950s cars, Old Havana cobblestones and Hemingway&apos;s bars&url=${typeof window !== "undefined" ? window.location.href : ""}`,
        },
      ].map((s) => (
        <a
          key={s.label}
